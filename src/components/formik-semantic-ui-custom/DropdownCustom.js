...
// https://github.com/turner-industries/formik-semantic-ui/blob/master/src/Dropdown.js
// Taken from here and updated to support additions
            ...
            <Form.Field error={!!error} {...fieldProps}>
              ...
              {error &&
                React.createElement(errorComponent, {
                  message: getIn(form.errors, name)
                })}
            </Form.Field>
          );
        }}
